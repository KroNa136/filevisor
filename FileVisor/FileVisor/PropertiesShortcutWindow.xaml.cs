...
namespace FileVisor
{
    public partial class PropertiesShortcutWindow : Window
    {
        ShortcutProperties properties;

        public PropertiesShortcutWindow(Window parent, FileSystemEntry entry)
        {
            InitializeComponent();

            properties = new ShortcutProperties(entry);
