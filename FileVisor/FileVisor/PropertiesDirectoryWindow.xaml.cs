...
namespace FileVisor
{
    public partial class PropertiesDirectoryWindow : Window
    {
        DirectoryProperties properties;

        public PropertiesDirectoryWindow(Window parent, FileSystemEntry entry)
        {
            InitializeComponent();

            properties = new DirectoryProperties(entry);
        ...
        void propertiesDirectoryWindow_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            properties.CancelAllAsyncOperations();
        }
